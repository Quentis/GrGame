...
Mesh::Indexed::P Mesh::Importer::fromAiMesh(ID3D11Device* device, aiMesh* assMesh)
{
...
//		elements[cElements].SemanticName = semanticName;
	...
	Mesh::Indexed::P indexed = Mesh::Indexed::create(device, indexBufferDesc, vertexStream);
